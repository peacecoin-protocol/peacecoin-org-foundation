...
thumbnailUrl: /assets/images/content/somic-coin-01/thumb.webp
---
...
<Col>
  <Flex>
    ![Folheto, caneta comemorativa, Moeda
    Somic](/assets/images/content/somic-coin-01/1.webp)
    _Folheto, caneta comemorativa, Moeda Somic_
  </Flex>
  <Flex>
    ![Mini palestra sobre aprendizado de
    florestas](/assets/images/content/somic-coin-01/2.webp)
    _Mini palestra sobre aprendizado de florestas_
  </Flex>
</Col>
...
<Col>
  <Flex>
    ![Serviço de chá de ervas](/assets/images/content/somic-coin-01/3.webp)
    _Serviço de chá de ervas_
  </Flex>
  <Flex>
    ![Experiência de produção de óleo
    essencial](/assets/images/content/somic-coin-01/4.webp)
    _Experiência de produção de óleo essencial_
  </Flex>
</Col>
...
![Diagrama do Modelo](/assets/images/content/somic-coin-01/5.webp)
_Diagrama do Modelo_
