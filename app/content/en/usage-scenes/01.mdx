...
<Col>
  ...
  <Flex>
    <PrimaryMat>
      #### 2. Obtain PCE (PEACE COIN) Testnet Coins

      <AppIcon src="/assets/images/usage-scenes/01/testnet-icon.png" />

      - You can obtain testnet coins to try PEACE COIN.
      - You can receive 500 tokens per day (\*amount subject to adjustment).
      <small>\* Mainnet release is planned for 2025 or later.</small>

      <Col className="gap-3">
        <Link to="https://peace-coin.org/get-coin">Get Testnet Coins Here</Link>
      </Col>
    </PrimaryMat>
...
<Link to="https://peace-coin.org/contact">
  Consulting support for implementation here
</Link>
